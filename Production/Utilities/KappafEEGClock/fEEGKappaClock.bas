...
GLOBAL gMillis, gSeconds, gMinutes, ghPDThread, gSampleCnt AS LONG
'------------------------------------------------------------------------------
'   ** Declarations **
'------------------------------------------------------------------------------
...
SUB processBuffer()
    ...
    LOCAL nbrOfChannels, bufSize, sampleCnt, y AS LONG
    ...
    DO
        ...
        #DEBUG PRINT STR$(gSampleCnt) + ": " + STR$(LEN(buffer))
            ...
            CASE 20
                LOCAL ch20 AS Channel20
                 ...
                 FOR y = 1 TO nbrOfChannels
                     ...
                     '#DEBUG PRINT "before Chan: " + STR$(y) + " " + STR$(ch02.Channels(y))
                 NEXT y
'                 ch20.ChannelStr = buffer
'                 FOR y = 1 TO nbrOfChannels
'                     ch20.Channels(y) = SwapBytesWord(ch20.Channels(y))
'                     #DEBUG PRINT "after Chan: " + STR$(y) + " " + STR$(ch02.Channels(y))
'                 NEXT y
        END SELECT
