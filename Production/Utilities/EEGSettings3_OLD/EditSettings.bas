...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    CONTROL ADD LISTBOX, ghEditSettingsDlg, %IDC_LISTBOX1, , 10, 25, 265, 335, %WS_CHILD _
    ...
    CONTROL ADD LABEL,   ghEditSettingsDlg, %IDC_LABEL2, "Click item to modify", _
        10, 10, 250, 15
    ...
    CONTROL SET FONT ghEditSettingsDlg, %IDC_LISTBOX1, hFont1
    ...
    CONTROL SET FONT ghEditSettingsDlg, %IDC_LABEL2, hFont2
#PBFORMS END DIALOG

    DIALOG SHOW MODAL ghEditSettingsDlg, CALL ShowDIALOG1Proc TO lRslt
...
FUNCTION SaveSettingsFile() AS LONG
    ...
    LISTBOX GET COUNT ghEditSettingsDlg, %IDC_LISTBOX1 TO lbCnt

    IF (lbCnt <> 0) THEN
        OPEN gSettingsSaveFile FOR OUTPUT AS #1
        PRINT #1, "Channel,Label"
        FOR x = 1 TO lbCnt
            LISTBOX GET TEXT ghEditSettingsDlg, %IDC_LISTBOX1, x TO temp
            PRINT #1, temp
        NEXT x
        CLOSE #1
...
FUNCTION LoadSettingsFile() AS LONG
    ...
    WHILE ISFALSE EOF(1)  ' check if at end of file
        LINE INPUT #1, temp
        LISTBOX ADD ghEditSettingsDlg, %IDC_LISTBOX1, temp
    WEND
    CLOSE #1
END FUNCTION
