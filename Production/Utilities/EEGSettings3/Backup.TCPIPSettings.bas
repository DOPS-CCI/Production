    ...
    SELECT CASE AS LONG CB.MSG
        ...
        CASE %WM_COMMAND
            ...
            SELECT CASE AS LONG CB.CTL
                ' /* Inserted by PB/Forms 11-01-2013 07:31:44
...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    DIALOG NEW PIXELS, hParent, "TCP/IP Settings", 344, 105, 646, 608, _
    ...
    CONTROL ADD LISTBOX,  hDlg, %IDC_LISTBOX_ChannelsToUse, , 10, 35, 200, _
    ...
    CONTROL ADD BUTTON,   hDlg, %IDC_BUTTON_BiosemiCfgFile, "Biosemi Cfg " + _
        "file", 222, 40, 120, 64
    CONTROL ADD LISTBOX,  hDlg, %IDC_LISTBOX_ThrottledSampleRate, , 520, 35, _
    ...
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_TCPServer, "", 208, 200, 187, 24
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_TCPPort, "", 478, 200, 82, 24
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_BytesInTCPArray, "", 209, 241, _
    ...
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_ReceiverTimeout, "60000", 460, _
        242, 82, 25
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_ChannelsSentByTCP, "", 210, 275, _
        83, 24, %WS_CHILD OR %WS_VISIBLE OR %WS_TABSTOP OR %ES_LEFT OR _
        %ES_AUTOHSCROLL OR %ES_READONLY, %WS_EX_CLIENTEDGE OR %WS_EX_LEFT OR _
        %WS_EX_LTRREADING OR %WS_EX_RIGHTSCROLLBAR
    CONTROL ADD TEXTBOX,  hDlg, %IDC_TEXTBOX_TCPSamplesPerChannel, "", 210, _
        307, 83, 26, %WS_CHILD OR %WS_VISIBLE OR %WS_TABSTOP OR %ES_LEFT OR _
        %ES_AUTOHSCROLL OR %ES_READONLY, %WS_EX_CLIENTEDGE OR %WS_EX_LEFT OR _
        %WS_EX_LTRREADING OR %WS_EX_RIGHTSCROLLBAR
    CONTROL ADD OPTION,   hDlg, %IDC_OPTION_TCPSubset0, "None    (0)", 48, _
        388, 112, 24
    CONTROL ADD OPTION,   hDlg, %IDC_OPTION_TCPSubset8, "A1-A8   (8)", 48, _
        412, 112, 24
    ' %WS_GROUP...
    CONTROL ADD OPTION,   hDlg, %IDC_OPTION_TCPSubset16, "A1-A16   (16)", 48, _
        436, 112, 24, %WS_CHILD OR %WS_VISIBLE OR %WS_GROUP OR %WS_TABSTOP _
        OR %BS_TEXT OR %BS_AUTORADIOBUTTON OR %BS_LEFT OR %BS_VCENTER, _
        %WS_EX_LEFT OR %WS_EX_LTRREADING
    CONTROL ADD OPTION,   hDlg, %IDC_OPTION_TCPSubset32, "A1-A32   (32)", 48, _
        460, 112, 24
    ...
    CONTROL ADD CHECKBOX, hDlg, %IDC_CHECKBOX_Add8EXElectrodes, "Add 8 EX " + _
        "electrodes", 353, 368, 200, 24
    CONTROL ADD CHECKBOX, hDlg, %IDC_CHECKBOX_Add7Sensors, "Add 7 Sensors", _
        353, 392, 200, 24
    CONTROL ADD CHECKBOX, hDlg, %IDC_CHECKBOX_Add9Jazz, "Add 9 Jazz", 353, _
        416, 200, 24
    ...
    CONTROL ADD CHECKBOX, hDlg, %IDC_CHECKBOX_AddTriggerStatusChan, "Add " + _
        "Trigger/Status Chan", 353, 464, 200, 24
    ...
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL1, "Actiview TCP Server IP:", 12, _
        200, 188, 24, %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL2, "Port:", 418, 200, 52, 24, _
        %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL3, "Bytes in TCP Array:", 59, 241, _
        144, 24, %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL4, "Channels sent by TCP:", 5, 273, _
        199, 26, %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL5, "TCP Samples/channel:", 35, 307, _
        169, 24, %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD FRAME,    hDlg, %IDC_FRAME1, "Actiview Server Information", _
        7, 176, 600, 370
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL7, "Receiver Timeout:", 310, 242, _
        144, 25, %WS_CHILD OR %WS_VISIBLE OR %SS_RIGHT, %WS_EX_LEFT OR _
        %WS_EX_LTRREADING
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL10, "Channels to use:", 8, 8, 200, _
        24
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL11, "Throttled Sample rate:", 352, _
        40, 160, 40
    CONTROL ADD FRAME,    hDlg, %IDC_FRAME2, "TCP Subset", 32, 360, 296, 152
    CONTROL ADD BUTTON,   hDlg, %IDC_BUTTON_Close, "Close", 378, 552, 105, 41
    ...
    CONTROL SET FONT hDlg, %IDC_LABEL11, hFont2
