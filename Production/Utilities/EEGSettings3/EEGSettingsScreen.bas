...
#PBFORMS BEGIN DIALOG %IDD_DIALOG_EEGSettings->->
    ...
    CONTROL ADD LABEL,    hDlg, %IDC_LABEL_HighlightChoices, "Please " + _
        "highlight the choices you want to use for Biosemi.", 8, 5, 448, 32
    ...
    CONTROL SET FONT hDlg, %IDC_CHECKBOX_UsePolhemus, hFont1
#PBFORMS END DIALOG
