...
#RESOURCE BITMAP, BITMAP_WHEEL1    "Images\Lightwheel2.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL2    "Images\Lightwheel2a.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL3    "Images\Lightwheel2b.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL4    "Images\Lightwheel2c.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL5    "Images\Lightwheel2d.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL6    "Images\Lightwheel2e.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL7    "Images\Lightwheel2f.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL8    "Images\Lightwheel2g.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL9    "Images\Lightwheel2h.bmp"
#RESOURCE BITMAP, BITMAP_WHEEL10   "Images\Lightwheel2i.bmp"
...
FUNCTION PBMAIN
    ...
    FOR x = 1 TO 10
        GRAPHIC BITMAP LOAD "BITMAP_WHEEL" + TRIM$(STR$(x)), EXPERIMENT.Stimulus.Rows * EXPERIMENT.Stimulus.LowerRightX, _
                        EXPERIMENT.Stimulus.LowerRightX * EXPERIMENT.Stimulus.LowerRightY TO gBmpHnd(x)
    NEXT x
   ...
   SELECT CASE globals.Response
    ...
    'iHPos = iHPos - 2
     ...
     ELSEIF (ghighOrLow = 2) THEN
         giVPos = giVPos - 1
     END IF
     #DEBUG PRINT STR$(giVPos)
     IF (giVPos > 10) THEN
         giVPos = 2
     ELSEIF (giVPos < 2) THEN
         giVPos = 10
     END IF


    GRAPHIC COPY gBmpHnd(giVPos),  %ID_GRID
    ...
    'GRAPHIC RENDER BITMAP "#BITMAP_WHEEL" + TRIM$(STR$(giVPos)), (EXPERIMENT.Stimulus.UpperLeftX, EXPERIMENT.Stimulus.UpperLeftY) - _
